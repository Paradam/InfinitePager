...
/**
 * A FragmentStatePagerAdapter that will behave as if it has an infinite number of pages,
 * or if the number of pages are less than {@link InfinitePagerAdapter#MIN}, behave as a normal 
 * {@link android.support.v4.app.FragmentStatePagerAdapter FragmentStatePagerAdapter}
 * 
 * <p>Applications targeting API {@link Build.VERSION_CODES#DONUT 4} and above should use this class,
 * applications targeting only API {@link Build.VERSION_CODES#HONEYCOMB_MR2 13} and above using the
 ...
 * {@link android.support.v4.app.FragmentStatePagerAdapter} that uses a {@link Fragment}
