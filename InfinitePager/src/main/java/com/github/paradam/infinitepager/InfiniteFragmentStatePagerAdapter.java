 ...
 * behave as a normal {@link android.support.v13.app.FragmentStatePagerAdapter FragmentStatePagerAdapter}<p/>
 *
 ...
 * {@link android.support.v13.app.FragmentStatePagerAdapter} that uses a {@link android.app.Fragment}
 ...
 * associated with each visited page as compared to {@link com.github.paradam.infinitepager.InfiniteFragmentPagerAdapter}
    ...
    public Object instantiateRelativeItem(ViewGroup container, int position) {
        ...
        if (mSavedState.size() > position) {
            ...
            if (fss != null && !f.isAdded()) {
                ...
                Log.e(TAG, "Error when instantiating Fragment: " + f + ", FragmentSavedState: " + fss + ", fragment already added: " + f
                        .isAdded());
            }
        }
